...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lstNombres.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Jose Molina", "Jose Molina", "Jose Molina", "Jose Molina", "Jose Molina", "Jose Molina" };
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Persona prsn = new Persona(nombre);
        
        mode1.addElement(prsn.getNombre());
        personas.add(prsn);
        lstNombres.setModel(mode1);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        
        Persona seleccion = personas.get(lstNombres.getSelectedIndex());
        mostPersona persona = new mostPersona(this,seleccion);
